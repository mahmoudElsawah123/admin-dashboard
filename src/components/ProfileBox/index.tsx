...
const ProfileBox = () => {
  ...
  const [formData, setFormData] = useState({
    ...
    emailAddress: '',
    username: '',
    aboutMe: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Pellentesque posuere fermentum urna, eu condimentum mauris tempus ut. Donec fermentum blandit aliquet. Etiam dictum dapibus ultricies. Sed vel aliquet libero. Nunc a augue fermentum, pharetra ligula sed, aliquam lacus.', 
    title : 'Admin Name',
  ...
  useEffect(() => {
    ...
    if (storedCover) setCoverPhoto(storedCover);
  ...
  return (
    <>
      ...
      <div className="relative z-20 h-35 md:h-65">
        <Image
          src={coverPhoto || "/images/cover/cover-01.png"}
          alt="profile cover"
        ...
        <div className="absolute bottom-1 right-1 z-10 xsm:bottom-4 xsm:right-4">
          ...
          >
            <input
              ...
              onChange={(e) => handleImageChange(e, setCoverPhoto, "coverPhoto")}
            />
            <span>🖼️</span>
        ...
        <div className="relative z-30 mx-auto -mt-22 h-30 w-full max-w-30 rounded-full bg-white/20 p-1 backdrop-blur sm:h-44 sm:max-w-[176px] sm:p-3">
          ...
          >
            <input
              ...
              className="sr-only"
              accept="image/png, image/jpg, image/jpeg"
              onChange={(e) => handleImageChange(e, setProfilePhoto, "profilePhoto")}
            />
            <span>📷</span>
          </label>
        </div>
